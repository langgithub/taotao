...
public class ItemServiceImpl implements ItemService {
	...
	public ItemInfo getItemById(Long itemId) {
		...
		try {
			System.out.println(REST_BASE_URL + ITME_INFO_URL + itemId);
			//调用rest的服务查询商品基本信息
	...
	public String getItemDescById(Long itemId) {
		try {
			System.out.println(REST_BASE_URL + ITEM_DESC_URL + itemId);
			//查询商品描述
	...
	public String getItemParam(Long itemId) {
		try {
			System.out.println(REST_BASE_URL + ITEM_PARAM_URL + itemId);
