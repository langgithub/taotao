...
public class ItemServiceImpl implements ItemService {
	...
	/**
	 * @param page 查询第几页
	 * @param rows 查询每页包含的记录数
	 * return EUDataGridResult序列化
	 */
	@Override
	...
	public TaotaoResult saveItem(TbItem item, String desc,String itemParam) throws Exception {
		...
		//添加商品描述
		TaotaoResult resultDesc=insertItemDesc(id,desc,date);
		if(resultDesc.getStatus()!=200){
			throw new Exception();
		}
		//商品规格
		TaotaoResult resultParam=insertItemParamItem(id,itemParam);
